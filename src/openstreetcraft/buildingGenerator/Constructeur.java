...
public abstract class Constructeur {
	...
	/**
	 * Construire un batiment � partir d'un tag et d'une liste de points.
	 * Ne construit rien mais faire appel � la classe correspondant au tag.
	 * @param value la valeur du tag.
	 * @param points la liste de points du contour du batiment.
	 * @param monde la Map o� construire le batiment.
	 * @param indexFacade l'indice du premier point de la fa�ade du batiment.
	...
	/**
	 * Appelle les constructeurs de la route avec les mat�riaux requis.
	...
	/**
	 * Construit un trottoir carr� autour du batiment.
	 * @param depart le point minimal du batiment.
	 * @param fin le point maximal du batiment.
	 * @param monde la Map o� se construit le trottoir.
	 */
	...
	/**
	 * R�ajuste le sol au niveau d'un bloc.
	 * Utile combler le trottoir en cas de Perlin incoh�rent.
	 * @param point l'endroit o� il faut r�ajuster.
	 * @param monde la Map dont le sol doit �tre r�ajust�.
	 */
	...
	/**
	 * Le point th�orique de coordonn�es minimales entre les Locations.
	 * @param points la liste des Locations
	 * @return un point ayant les coordonn�es les plus basses de la liste.
	 */
	...
	/**
	 * Le point th�orique de coordonn�es maximales entre les Locations.
	 * @param points la liste des Locations
	 * @return un point ayant les coordonn�es les plus hautes de la liste.
	 */
